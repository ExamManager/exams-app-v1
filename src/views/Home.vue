          ...
          <div>
            ...
            <div class="mt-20">
              ...
              <div class="mt-6 sm:max-w-xl">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Examtime management for Schools</h1>
              ...
              <form action="#" class="mt-12 sm:flex sm:w-full sm:max-w-lg">
                ...
                <div class="mt-4 sm:mt-0 sm:ml-3">
                  <button type="submit" class="block w-full rounded-md border border-transparent bg-indigo-600 px-5 py-3 text-base font-medium text-white shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:px-10">Sign Up</button>
                </div>
              </form>
              <div class="mt-6">
                <div class="inline-flex items-center divide-x divide-gray-300">
                  ...
                  <div class="min-w-0 flex-1 py-1 pl-5 text-sm text-gray-500 sm:py-3"><span class="font-medium text-gray-900">Rated 4.8 Starts</span> by over <span class="font-medium text-indigo-600">200 Schools</span></div>
                </div>
              </div>
            </div>
          </div>
