...
<template v-if="this.loading === false">
  ...
  >
    <Menu
      v-if="loading === false"
      as="div"
      class="fixed right-4 top-4 ml-4 flex-shrink-0"
    >
      <div>
            ...
            <div class="px-4 py-5 sm:p-6">
              ...
              <div class="mt-2">
                <div v-for="(method, index) in paymentMethods" :key="index">
                  <div @click.native="selectedMethod = index"
                    :class="['rounded-md px-6 py-5 mt-4 sm:flex sm:items-start sm:justify-between bg-gray-50', index === selectedMethod ? 'border-gray-900 border-2' : 'border-2 border-transparent hover:border-gray-200 cursor-pointer']">
                    ...
                    <div class="mt-4 sm:mt-0 sm:ml-6 sm:flex-shrink-0">
                      <button
                        type="button"
                        class="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 sm:text-sm"
                      >
                        <TrashIcon class="hidden sm:block h-4 w-4 mr-2" aria-hidden="true" />Delete
                      </button>
                    </div>
                  </div>
                </div>
