...
export default {
  ...
  methods: {
    ...
    async getUserInfo() {
      ...
      this.user = user;
      this.provider = localStorage.getItem("provider") || "email";
      this.fullname = localStorage.getItem('fullname') || 'Example User';
      this.profilepic = localStorage.getItem('profilepic') || 'https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=4&w=256&h=256&q=80';
      this.loading = false;
      ...
      <div>
        <MenuButton class="flex p-2.5 rounded-lg shadow bg-white">
          <div class="flex items-center">
            <div>
              <img class="flex  h-5 w-5 rounded-full" :src="this.profilepic" referrerpolicy="no-referrer"
                alt="" />
            </div>
            <div class="ml-3">
          ...
          <form action="#" method="POST">
            <div class="shadow sm:overflow-hidden sm:rounded-md">
              <div class="bg-white py-6 px-4 sm:p-6">
                ...
                <!-- SCHOOL -->
                <div v-if="this.user.plan === 0" class="mt-6 grid grid-cols-4 gap-6">
                  <div class="col-span-4 sm:col-span-2">
                    ...
                    <input readonly type="text" name="school-name" id="school-name"
                      :value=this.userdata.user_metadata.full_name
                ...
                <!-- PERSONAL -->
                <div v-if="false" class="mt-6 grid grid-cols-4 gap-6">
                  <div class="col-span-4 sm:col-span-2">
                    <label for="first-name" class="block text-sm font-medium text-gray-700">School Name</label>
                    <input readonly type="text" name="school-name" id="school-name"
                      :value=this.userdata.user_metadata.full_name
