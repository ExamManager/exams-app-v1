        ...
        <main>
            ...
            <section aria-labelledby="pricing-heading">
                <div class="bg-white">
                    ...
                    <div class="mt-8 bg-gray-100 pb-12 sm:mt-12 sm:pb-16 lg:mt-16 lg:pb-24">
                        <div class="relative">
                                ...
                                <div
                                    ...
                                    <div v-for="tier in tiers" :key="tier.name"
                                        ...
                                        <div class="bg-white px-6 py-8 sm:p-10 sm:pb-6">
                                            <div>
                                                <h3 class="inline-flex rounded-full bg-orange-100 px-4 py-1 text-base font-semibold text-orange-600"
                                                    id="tier-standard">{{ tier.name }}</h3>
                                            </div>
