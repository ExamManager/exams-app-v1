  ...
  <div class="fixed bottom-0 left-0 p-4">
    <a href="https://bitstore.dev" target="_blank" class="text-gray-500 hover:text-gray-600 transition duration-150 ease-in-out">
      <div class="flex items-center space-x-2 drop-shadow-md">
        ...
        <transition enter-active-class="transition ease-out duration-100" enter-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-75" leave-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1">
          <span class="text-xs font-medium">Creators</span>
        </transition>
      </div>
    </a>
  </div>
