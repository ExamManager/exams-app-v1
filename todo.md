...
- examtimer.tech/multiexam = Multi Exam Timer (multiple exams at once) - requires account
- examtimer.tech/premiumexam = Premium Exam Timer (external display function) - requires premium subscription