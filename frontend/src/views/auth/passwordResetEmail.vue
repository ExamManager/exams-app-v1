...
<!-- Body for T1 -->
<body style="margin: 0; min-height: 100vh; background-color: #091548; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
											...
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 15px; padding-left: 10px; padding-right: 10px; padding-top: 15px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="image_block block-1" width="100%" border="0" cellpadding="5" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="font-size: 14px; font-family: 'Varela Round', 'Trebuchet MS', Helvetica, sans-serif; mso-line-height-alt: 21px; color: #ffffff; line-height: 1.5;">
																<div class="alignment" align="center" style="line-height:10px; display: flex; flex-direction: row; justify-content: center; align-items: center">
																		<img src="https://i.vgy.me/HGoEMr.png" style="display: block; height: 40px; border: 0; width: auto; max-width: 100%;" width="145" alt="Your Logo" title="Your Logo">
																		<a style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;" target="_blank" href="https://examtimer.tech">Examtimer.tech</a>
																	</div>
															</td>
														</tr>
													</table>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class style="font-size: 12px; font-family: 'Varela Round', 'Trebuchet MS', Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #4a60bb; line-height: 1.2;">
																		<p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 14.399999999999999px;"><span style>Copyright © 69BC - 2023 Exam Timer, All rights reserved.<br><br>Where to find us: Edmonstone and Thomason house, Haileybury Imperial and Service College - we're still students :)</span></p>
																	</div>
																</div>
															</td>
														</tr>
