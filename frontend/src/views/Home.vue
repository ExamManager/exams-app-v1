      ...
      <div class="overflow-hidden pt-8 sm:pt-12 lg:relative lg:py-48">
            ...
            <div class="mt-16">
              <div>
                <a href="#" class="inline-flex space-x-4">
                  <span
                    class="rounded bg-orange-50 px-2.5 py-1 text-sm font-semibold text-orange-400"
                    >What's new</span
                  >
                  <span
                    class="inline-flex items-center space-x-1 text-sm font-medium text-orange-400"
                  >
              ...
              <div class="mt-6 sm:max-w-xl">
                <transition
                  enter-active-class=" ease-in-out duration-700 transition"
        ...
        <div class="sm:mx-auto sm:max-w-3xl sm:px-6">
          ...
          >
            ...
            >
              <transition
                enter-active-class="transform ease-out duration-1000 transition"
      ...
      <div class="relative mx-auto max-w-xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div class="relative">
          ...
          <p class="mx-auto mt-4 max-w-3xl text-center text-xl text-gray-500">
            Give students a non distractive way to keep track of their time during exams.
            See how much time you have left in your exam at a glance.
          </p>
        </div>
        ...
        >
          <div class="relative">
            <h3 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
              Give students a clearer view
            </h3>
            <p class="mt-3 text-lg text-gray-500">
              Say goodbye to the complexities of manual exam management. With ExamTimer,
              you can streamline your exam processes, enhance efficiency, and create a
              seamless experience for teachers, examiners, and students alike.
            </p>
            ...
            <dl class="mt-10 space-y-10">
              <div v-for="item in transferFeatures" :key="item.id" class="relative">
                <dt>
                  <div
                    class="absolute flex h-12 w-12 items-center justify-center rounded-md bg-orange-400 text-white"
                  >
        ...
        <div class="relative mt-12 sm:mt-16 lg:mt-24">
          ...
          >
            <div class="lg:col-start-2">
              ...
              <p class="mt-3 text-lg text-gray-500">
                Enhance exam conditions and empower students with ExamTimer's flexible
                time management features. Customize extra time allocation and accurately
                track reading time for a fair and efficient exam process.
              </p>
                      ...
                      <div class="flex items-start">
                        ...
                        <div class="ml-3 w-0 flex-1 pt-0.5">
                          ...
                          <p class="mt-1 text-sm text-gray-500">
                            Maths Paper 1 has been started
                          </p>
                        </div>
                    ...
                    <div class="p-4">
                      <div class="flex items-start">
                        ...
                        <div class="ml-3 w-0 flex-1 pt-0.5">
                          ...
                          <p class="mt-1 text-sm text-gray-500">
                            English Paper 2 has started reading time
                          </p>
                        </div>
                        <div class="ml-4 flex flex-shrink-0">
                          <button
                    ...
                    <div class="p-4">
                      <div class="flex items-start">
                        ...
                        <div class="ml-3 w-0 flex-1 pt-0.5">
                          ...
                          <p class="mt-1 text-sm text-gray-500">
                            Physics Paper 3 has started reading time
                          </p>
                        </div>
                        <div class="ml-4 flex flex-shrink-0">
                          <button
                    ...
                    <div class="p-4">
                      <div class="flex items-start">
                        ...
                        <div class="ml-3 w-0 flex-1 pt-0.5">
                          ...
                          <p class="mt-1 text-sm text-gray-500">
                            Biology Paper 1 could not be added
                          </p>
                        </div>
                        <div class="ml-4 flex flex-shrink-0">
                          <button
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="text-center">
            ...
            <p class="mt-4 text-xl text-gray-600">
              If you're not satisfied, contact us within the first 14 days and we'll send
              you a full refund.
            </p>
          </div>
        </div>
              ...
              <div class="flex-1 bg-white px-6 py-8 lg:p-12">
                ...
                <div class="mt-8">
                  <div class="flex items-center">
                    <h4
                      class="flex-shrink-0 bg-white pr-4 text-base font-semibold text-orange-600"
                    >
                      What's included
                    </h4>
              ...
              >
                ...
                <p class="mt-4 text-sm">
                  <a href="#" class="font-medium text-gray-500 underline"
                    >Learn about our Subscribtion policy</a
                  >
                </p>
                <div class="mt-6">
    ...
    >
      ...
      <div class="mt-8 md:order-1 md:mt-0">
        <p class="text-center text-base text-gray-400">
          &copy; 2023 Examtimer, Inc. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
