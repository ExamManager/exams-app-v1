  ...
  methods: {
    ...
    addExam() {
      ...
      if (
        ...
        // turn this.newExam into Exam type
        var tmpExam = new Exam(
          this.newExam.start,
          this.newExam.end,
          this.newExam.subject,
          this.newExam.yearGroup,
          this.newExam.title,
          this.newExam.description,
          this.newExam.notes,
          this.newExam.room,
          this.newExam.invigilators,
          this.newExam.files,
          this.currentExamIndex + 1,
          this.newExam.color,
          this.newExam.options
        )

        console.log("TMPEXAM", tmpExam)
              ...
              <div class="space-y-8 divide-y divide-gray-200">
                ...
                <div class="pt-5">
                  <div class="flex justify-end">
                    ...
                    <button
                      @click="popupedit ? updateExam() : addExam()"
