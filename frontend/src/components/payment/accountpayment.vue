              ...
              <div class="space-y-6 p-4">
                ...
                >
                  <div
                    ...
                    v-if="this.paymentMethods.length > 0"
                  >
                            ...
                            >
                              ...
                              >
                                ...
                                <div class="sm:flex sm:items-start">
                                  ...
                                  <svg
                                    v-if="method.cardType == 'mastercard'"
                                    width="36px"
                                    height="24px"
                                    viewBox="0 0 200 120"
                                    class="rounded-md"
                                  ...
                                  >
                                    ...
                                    >
                                      <g
                                        id="Large"
                                        transform="translate(-32.000000, -968.000000)"
                                      >
                                        <g
                                ...
                                <div
                                  class="mt-4 flex sm:pt-2 sm:mt-0 sm:ml-6 sm:flex-shrink-0"
                                  v-if="method.default"
                                >
                                  <span
                                ...
                                <div class="flex space-x-2">
                                  <button
                                    @click="
                                      updateDefaultPaymentMethod2(
                                        method.paymentId
                                      )
                                    "
                                    alt="Make this the default payment method"
                                    v-if="editdefaultpayment"
                                  ...
                                  <button
                                    @click="
                                      deletePaymentMethod2(method.paymentId)
                                    "
                                    v-if="editdefaultpayment"
                                    class="space-x-2 p-2 flex flex-shrink-0 border-0 bg-white rounded-md"
                                  >
                    ...
                    <div
                      class="bg-gray-50 px-4 py-3 space-x-2 text-right sm:px-6"
                    >
                      <button
                        @click="
                          this.editdefaultpayment
                            ? (this.editdefaultpayment = false)
                            : (this.editdefaultpayment = true)
                        "
                ...
                <div aria-labelledby="payment-details-heading">
                  <div class="shadow sm:overflow-hidden sm:rounded-md">
                      ...
                      <div class="mt-6 grid grid-cols-4 gap-6">
                        ...
                        <div class="flex justify-end">
                          <div class="inline-flex items-center">
                            <label
                              for="default-payment"
                              class="block text-sm font-medium text-gray-700 mr-4 flex-shrink-0"
                              >Set as default payment method</label
                            >
                            <input
                              type="checkbox"
                              name="default-payment"
                              v-model="addCard.defaultPayment"
                              autocomplete="default-payment"
                              class="mt-1 block mb-1 rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:border-gray-900 focus:outline-none focus:ring-gray-900 sm:text-sm"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <div
                      class="bg-gray-50 flex px-4 py-3 sm:px-6 space-x-2 items-center"
                    >
                      <div
                        v-if="!loading2"
                        class="text-right w-full justify-end space-x-2 flex-shrink"
                      >
                        <button
                      ...
                      >
                        <button
                          disabled
                          class="inline-flex justify-center rounded-md border border-transparent bg-red-500 py-2 px-4 text-sm font-medium text-white shadow-sm"
                        >
                          <svg
        ...
        <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div class="overflow-hidden rounded-lg bg-white shadow">
                  ...
                  <dl>
                    ...
                    <dd>
                      ...
                      >
                        <div
                          v-if="loading4"
                          class="h-7 animate-pulse bg-gray-50 rounded"
                        />
                        <div v-else class="text-lg font-medium text-gray-900">
                          In {{ this.nextbilling }} days
                        </div>
                      </transition>
                    </dd>
                  </dl>
            ...
            <div class="bg-gray-50 px-5 py-3">
              <div class="text-sm">
                <a class="font-medium text-orange-500 hover:text-orange-700"
                  >View all</a
                >
              </div>
            </div>
