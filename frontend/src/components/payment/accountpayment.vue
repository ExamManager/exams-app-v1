...
import { MagnifyingGlassIcon, QuestionMarkCircleIcon, TrashIcon } from "@heroicons/vue/20/solid";
import {
  Disclosure,
  DisclosureButton,
  DisclosurePanel,
          ...
          <div class="mt-2">
            <div v-for="(method, index) in paymentMethods" :key="index">
              <div
                ...
                :class="[
                  'rounded-md px-6 py-5 mt-4 sm:flex sm:items-start sm:justify-between bg-gray-50',
                  index === selectedMethod
                    ? 'border-gray-900 border-2'
                    : 'border-2 border-transparent hover:border-gray-200 cursor-pointer'
                ]"
              >
                ...
                <div class="mt-4 sm:mt-0 sm:ml-6 sm:flex-shrink-0">
                  ...
                  >
                    <TrashIcon
                      class="hidden sm:block h-4 w-4 mr-2"
                      aria-hidden="true"
                    />Delete
                  </button>
                </div>
